...
public class GestNiveau : MonoBehaviour
{
    ...
    [Header("Donnes et interfaces")] //Entete de section pour les données et l'interface
    ...
    [Header("Caracteristiques du niveau")] //Entete de section pour les caractéristiques du niveau
    ...
    private void Ajouter(int nb, GameObject prefab) //prevoir les 2 parametres requis
    {
        for (int i = 0; i < nb; i++)
        {
            ...
            gO.transform.position = new Vector3(x,y,0); //appliquer la position en x et y
        }
    }
    ...
    public void RecupererTresor(int points) //ne pas oublier d'ajouter le parametre
    {
        ...
        {
            _iNavig.AllerNiveauSuivant(); /*ici*/ //changer de scene avec la methode des infos de navigation  
        }
    }
    ...
    public void PerdreVie()
    {
        ...
        {
            _iNavig.AllerFin();
        } //si mort pour vrai, aller a la scene de fin
    }
}